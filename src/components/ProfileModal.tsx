  ...
  const pricingTiers = [
    {
      ...
      credits: "100 Credits",
      price: "$19",
      description: "Ideal for individual developers or small site audits.",
      features: [
        "100 audit page scans",
    ...
    },
    {
      ...
      credits: "500 Credits",
      price: "$49",
      description: "Best for growing sites needing active audits.",
      features: [
        "500 audit page scans",
        "Higher rate crawling speeds",
    ...
    },
    {
      ...
      price: "$99",
      description: "For agencies and large scale web properties.",
      features: [
        "1500 audit page scans",
        "Max concurrency crawling",
