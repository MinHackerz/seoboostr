...
export const metadata: Metadata = {
  title: "Privacy Policy | SEOBoostr",
  description: "Learn how SEOBoostr handles your data, privacy, and account information with our detailed privacy statement.",
  openGraph: {
    title: "Privacy Policy | SEOBoostr",
    description: "Learn how SEOBoostr handles your data, privacy, and account information.",
    url: "https://seoboostr.io/privacy",
    type: "website",
  },
};
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        <div className="rounded-3xl p-8 sm:p-12 border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-2xl shadow-teal-500/5 relative overflow-hidden">
          ...
          <div className="space-y-6 text-sm text-slate-300 leading-relaxed font-medium">
            ...
            <p>
              At SEOBoostr, accessible from seoboostr.io, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SEOBoostr and how we use it.
            </p>
            ...
            <p>
              SEOBoostr follows standard logging procedures. These logs record visitors when they visit websites. NextAuth and Google OAuth use cookies to maintain secure user sessions.
            </p>
